...
class BridgeBevelCorridorTest(AnvilTestCase):
    ...
    def test_bridge_and_bevel_corridor_3_segments(self):
        ...
        expected = {
            ...
            (0.0, -0.0, 1.0, 0.5, 1.0, 0.25):    (1.0, 1.0, 180.0, 0.75, 0.25),
            ...
            (-0.26, 0.0, -0.97, 0.68, 1.0, 0.74): (1.0, 1.0, 180.0, 0.75, 0.81),
            (-0.71, 0.0, -0.71, 0.72, 1.0, 0.72): (1.0, 1.0, 180.0, 0.75, 0.75),
            (-0.97, 0.0, -0.26, 0.74, 1.0, 0.67): (1.0, 1.0, 180.0, 0.75, 0.70),
            (0.26, 0.0, -0.97, 0.32, 1.0, 0.74):  (1.0, 1.0, 180.0, 0.25, 0.81),
            (0.71, 0.0, -0.71, 0.28, 1.0, 0.72):  (1.0, 1.0, 180.0, 0.25, 0.75),
            (0.97, 0.0, -0.26, 0.26, 1.0, 0.67):  (1.0, 1.0, 180.0, 0.25, 0.70),
            (0.0, 0.0, -1.0, 0.5, 1.0, 0.75):     (1.0, 1.0, 0.0, 0.35, 0.75),
            ...
            # --- Corridor side walls ---
            (-1.0, 0.0, 0.0, 0.75, 1.0, 0.45):   (1.0, 1.0, -90.0, 0.75, 0.65),
            (1.0, -0.0, 0.0, 0.25, 1.0, 0.45):   (1.0, 1.0, 90.0, 0.25, 0.25),
    ...
    def test_single_edge_bevel_1_segment_interactive(self):
        ...
        expected = {
            ...
            (0.0, 1.0, -0.0, 0.5, 2.0, 0.12):      (1.0, 1.0, 180.0, 0.75, 0.25),
            (0.0, -0.0, 1.0, 0.5, 1.0, 0.25):      (1.0, 1.0, 180.0, 0.75, 0.25),
            (1.0, -0.0, 0.0, 0.25, 1.0, 0.5):      (1.0, 1.0, 90.0, 0.25, 0.25),
            (-0.0, -1.0, 0.0, 0.74, 0.0, 0.74):    (1.0, 1.0, -45.0, 0.65, 0.75),
            (0.0, 1.0, 0.0, 0.74, 2.0, 0.74):      (1.0, 1.0, 45.0, 0.25, 0.65),
            (-0.71, 0.0, -0.71, 0.7, 1.0, 0.7):    (1.0, 1.0, 180.0, 0.75, 0.79),
            (0.0, 0.0, -1.0, 0.45, 1.0, 0.75):     (1.0, 1.0, 0.0, 0.25, 0.75),
            (0.0, -1.0, 0.0, 0.86, 0.0, 0.54):     (1.0, 1.0, -112.5, 0.82, 0.82),
