"""Convex prism representation used by the shared cut engine.

The representation is independent of any drawing UI so every profile-based
cut tool can use the same intersection and reconstruction pipeline.
"""
